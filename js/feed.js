...
//var TOKEN = 'eyJyYW5kIjogNjU2NDksICJleHBpcmVzIjogMTM5MTgxNjkxOC4wMjIxOTUxLCAidXNlcl9pZCI6IDY0MTYsICJzYWx0IjogImVjOTdiNSJ9psj3ggNRx213H8fJZ8KMlaKORu4=';
var TOKEN = 'eyJyYW5kIjogNzA0NzMsICJleHBpcmVzIjogMTM4NjIzNDU4Ni44NjQ5NDcxLCAidXNlcl9pZCI6IDY1NjAsICJzYWx0IjogIjIyODg2YiJ9XwvTAZSwjwX2UntEdGHfNDDTKHc=';
//var TOKEN = 'token';
var GET_QUOTES = WEBSERVER + 'get_quotes?token=' + TOKEN + '&limit=5';
...
var ADD_FEEDBACK = WEBSERVER + 'add_feedback';

var FB_GRAPH = 'https://graph.facebook.com/';

var FBID = '1454031404';
// IMPORTANT: go to https://developers.facebook.com/tools/explorer/ to get a new one
var FB_ACCESS_TOKEN = 'CAACEdEose0cBAH2apI2jGN3ZBWRnGk9BQ6z2ghZA1EmA9tZCQP0hHzPFk0oAZBwsTSJWl8jbzb2Bdh26z1UiFpEqvOdGGvZBEBRsKAkaZBFmym9wkryB4s29fZABe4peymSiJzhPNonKxhBaui6a5zd7zSnlQqzxZBNylaomXJS3Rk7EeN1fuX0w798pZCf26rZBgZD';
...
function onFeedUpdateSuccess(data, textStatus, jqXHR) {
	...
	if (content.length > maxlen) {
        ...
        $('#source-'.concat(i)).html(quote.source_name);
	$('#quote-'.concat(i)).html(content);
	$('#reporter-'.concat(i)).html(quote.reporter_name);
	$('#pic-'.concat(i)).attr('src', quote.source_picture_url);
    }
}
...
function addFeedback() {
    var content = $('#new-feedback-content').val();
    $.ajax({
        'url' : ADD_FEEDBACK,
        'type' : 'POST',
        'dataType' : 'json',
        ...
        'success' : addFeedbackSuccess, 
        'error' : genericError 
    });
}

function addFeedbackSuccess(data, textStatus, jqXHR) {
...
/*
    ...
    $('#add-feedback').click(addFeedback);
